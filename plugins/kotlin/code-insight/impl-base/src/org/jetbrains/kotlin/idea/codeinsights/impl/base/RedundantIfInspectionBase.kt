...
open class RedundantIfInspectionBase : AbstractKotlinInspection(), CleanupLocalInspectionTool {
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean, session: LocalInspectionToolSession): PsiElementVisitor {
        return ifExpressionVisitor { expression ->
            ...
            holder.registerProblem(
                ...
                RemoveRedundantIf(redundancyType, branchType, isBooleanPrefixExpression)
            )
        }
    }

    open val isBooleanPrefixExpression = { _: KtExpression -> false }
    ...
    private class RemoveRedundantIf(private val redundancyType: RedundancyType,
                                    ...
                                    private val isBooleanPrefixExpression: (KtExpression) -> Boolean) : LocalQuickFix {
        ...
        override fun applyFix(project: Project, descriptor: ProblemDescriptor) {
            ...
            val condition = when (redundancyType) {
                ...
                RedundancyType.ELSE_TRUE -> element.condition!!.negate(isBooleanPrefixExpression = isBooleanPrefixExpression)
            }
